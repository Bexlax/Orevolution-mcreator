...
public class Modelarmor_reinforced_netherite<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "armor_reinforced_netherite"), "main");
	...
	public Modelarmor_reinforced_netherite(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_shoe = partdefinition.addOrReplaceChild("left_shoe",
				CubeListBuilder.create().texOffs(0, 16).mirror()
						...
						.texOffs(16, 32).addBox(-3.05F, 6.25F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.2F)),
				PartPose.offset(1.9F, 12.0F, 0.0F));

		PartDefinition right_shoe = partdefinition.addOrReplaceChild("right_shoe",
				CubeListBuilder.create().texOffs(0, 16)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.75F)).texOffs(16, 32)
						.addBox(-3.0F, 6.25F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.2F)),
				PartPose.offset(-1.9F, 12.0F, 0.0F));
		...
		PartDefinition left_arm_r1 = left_arm.addOrReplaceChild("left_arm_r1",
				CubeListBuilder.create().texOffs(0, 32).mirror()
						.addBox(-2.0F, -6.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.8F)).mirror(false),
				PartPose.offsetAndRotation(2.0F, 3.5F, 0.0F, 0.0F, 0.0F, -0.1309F));
